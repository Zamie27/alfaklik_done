...
<body>
    ...
    <nav class="bg-light p-3 shadow-sm sticky-top">
        <div class="container d-flex align-items-center justify-content-between">
            <!-- Logo -->
            <a class="navbar-brand d-flex align-items-center" href="<?= base_url('pelanggan/dashboard'); ?>">
                <img src="<?= base_url(); ?>/img/logo.png" alt="Alfagift Logo" class="me-2" height="40" />
            </a>
            <!-- Search Bar -->
            <div class="d-flex flex-grow-1 mx-5">
                <form action="<?= base_url('pelanggan/search') ?>" method="GET" class="d-flex flex-grow-1 w-100">
                    <input
                        type="text"
                        name="q"
                        class="form-control"
