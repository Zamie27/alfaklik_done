...
class Dashboard extends BaseAdmin
{
    ...
    public function deleteAkun($id)
    {
        ...
        return redirect()->to('admin/dashboard/akun')->with('success', 'Akun pengguna berhasil dihapus');
    }
    ...
    public function laporanPenjualan()
    {
        ...
        return view('users/admin/laporan_penjualan', $data);
    }

    // Detail Order
    public function detailOrder($id_orders)
    {
        ...
        if (!$order) {
            return redirect()->to('admin/laporan-penjualan')->with('error', 'Order tidak ditemukan.');
        }

        $items = $db->table('order_details')
            ->select('order_details.*, barang.nama_barang, barang.gambar_barang')
            ->join('barang', 'barang.id_barang = order_details.id_barang', 'left')
            ->where('order_details.id_orders', $id_orders)
            ->get()
            ->getResultArray();
        ...
        return view('users/admin/detail_order', $data);
    }
}
