            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <form action="<?= base_url('krew/dashboard/profile/updatePhoto') ?>" method="POST" enctype="multipart/form-data" class="mt-3">
                            <?= csrf_field(); ?>
                    ...
                    <hr>
                    <!-- Form Profil -->
                    <form action="<?= base_url('krew/dashboard/profile/update') ?>" method="POST">
                        <?= csrf_field(); ?>
                        <!-- Nama Lengkap -->
                        <div class="mb-3">
